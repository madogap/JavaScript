...
function exibirVaga() {
    const indice = prompt("Informe o índide da vaga que deseja exibir:")
...
function inscreverCandidato() {
    ...
    const indice = prompt("Informe o índice da vaga para o qual o candidato deseja se inscrever")
    const vaga = vagas[indice]
